/*
 * REFERENCE IMPLEMENTATION OF backward bias epsilon_a searching programme as mentioned in syncopatation paper
 *
 ...
 *
 * Synopsis:
 * This file contains the new backward bias searching programme for the stream cipher ChaCha.
 * running command: g++ syncobwbias.cpp && ./a.out
...
int main()
{
    ...
    // ---------------------------Printing--------------------------------------------------------------------
    cout << "                   The backward bias programme accroding to the SYNCOPATION paper \n";
    ...
    std::cout << "+------------------------------------------------------------------------------------+\n";
    cout << "           The bias value should have been " << setprecision(5) << sqrt(0.000517) << "\n";
    ...
    while (loop < ITERATION)
    {
        ...
        {
            double epsilon = 2 * (count / loop) - 1.0; // their work
            double varepsilon = epsilon * epsilon;     // conventional
            // cout << "🔢 #loop : " << setw(4) << ++counter << " | 🎆bias : epsilon: " << fixed << setprecision(7) << varepsilon << " their epsilon: "<< setprecision(5) << epsilon<< " ~ " << setprecision(5) << fabs(varepsilon) << setprecision(2) << " ~ 2 ^{" << log2(fabs(varepsilon)) << "}\n";

            cout << "their bias: " << fixed << setprecision(5) << fabs(epsilon) << ", conventional bias: " << setprecision(8)<< varepsilon << "\n";
        }
    }
}
